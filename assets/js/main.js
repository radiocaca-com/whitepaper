/**
 * Template Name: SafeMars
 * Template URL: https://safemarscrypto.com
 * Author: SafeMars
 */
!( function ( $ ) {
		"use strict";
...
$.getJSON (
		...
		function ( data ) {
				...
				var burned    = data.market_data.total_supply - data.market_data.circulating_supply;
				...
				// $ ( ".burned" ).append ( marketf.format ( burned / 1000000000000 ) + " T" );
...
$.ajax ( {
						 type: 'GET',
						 url: "https://ucbirim.com/SafeMarsLiqHold/safeMars.json",
						 headers: {
						 ...
						 success: function ( records ) {
								 ...
								 var holders = records.holders;
								 var liquid  = records.totalLP;
								 ...
								 $ ( ".holders" ).append ( formatter.format ( holders ) );
								 $ ( ".liquidity" ).append ( formatter.format ( liquid ) );
								 $ ( ".price" ).append ( formatter.format ( price ) + "$" );
...
// $.getJSON (
// 		"https://ucbirim.com/SafeMarsLiqHold/safeMars.json?jsoncallback=?",
// 		{
// 				format: "jsonp",
// 		},
// 		function ( records ) {
